...
public abstract class BaseBookPeer
{
    ...
    /** The column for the AUTH_ID field */
    public static final ColumnMap AUTH_ID;
    /** The column for the TITLE field */
    public static final ColumnMap TITLE;
    /** The column for the SUBJECT field */
    public static final ColumnMap SUBJECT;
    ...
    static
    {
        ...
        TABLE.setOMClass(com.example.om.Book.class);
        TABLE.setPeerClass(com.example.om.BookPeer.class);
    ...
    // ------------- Column: AUTH_ID --------------------
        AUTH_ID = new ColumnMap("AUTH_ID", TABLE);
        AUTH_ID.setType(Integer.valueOf(0));
        AUTH_ID.setTorqueType("INTEGER");
        AUTH_ID.setUsePrimitive(true);
        AUTH_ID.setPrimaryKey(false);
        AUTH_ID.setNotNull(true);
        AUTH_ID.setJavaName("AuthId");
        AUTH_ID.setAutoIncrement(true);
        AUTH_ID.setProtected(false);
        AUTH_ID.setJavaType( "int" );
        AUTH_ID.setPosition(2);
        TABLE.addColumn(AUTH_ID);
    // ------------- Column: TITLE --------------------
    ...
    // ------------- Column: SUBJECT --------------------
        SUBJECT = new ColumnMap("SUBJECT", TABLE);
        SUBJECT.setType("");
        SUBJECT.setTorqueType("VARCHAR");
        SUBJECT.setUsePrimitive(false);
        SUBJECT.setPrimaryKey(false);
        SUBJECT.setNotNull(true);
        SUBJECT.setJavaName("Subject");
        SUBJECT.setAutoIncrement(true);
        SUBJECT.setProtected(false);
        SUBJECT.setJavaType( "String" );
        SUBJECT.setSize(64);
        SUBJECT.setPosition(4);
    ...
    // ------------- Foreign keys --------------------
        ...
        else
        {
            ...
            foreignKeyMap.addColumns(new ForeignKeyMap.ColumnPair(
                foreignKeyMap,
                TABLE.getColumn("AUTH_ID"),
                foreignTable.getColumn("AUTH_ID")));
        }
    ...
    public static BookPeerImpl getBookPeerImpl()
    {
        ...
        if (peerImplInstance == null)
        {
            ...
            Torque.registerPeerInstance(Book.class, peerImplInstance);
        }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<Book> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getBookPeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getBookPeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getBookPeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getBookPeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getBookPeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getBookPeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Book> retrieveByTypedPKs(Collection<Integer> pks)
        throws TorqueException
    {
        return getBookPeerImpl().retrieveByTypedPKs(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Book> retrieveByTypedPKs(
                Collection<Integer> pks,
                Connection dbcon)
            throws TorqueException
    {
        return getBookPeerImpl().retrieveByTypedPKs(pks, dbcon);
    }
    ...
    public static List<Book> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getBookPeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Book> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getBookPeerImpl().retrieveByObjectKeys(pks, con);
    }
