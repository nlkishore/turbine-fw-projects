...
public abstract class BaseAuthorPeer
{
    ...
    static
    {
        ...
        TABLE.setOMClass(com.example.om.Author.class);
        TABLE.setPeerClass(com.example.om.AuthorPeer.class);
    ...
    public static AuthorPeerImpl getAuthorPeerImpl()
    {
        ...
        if (peerImplInstance == null)
        {
            ...
            Torque.registerPeerInstance(Author.class, peerImplInstance);
        }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<Author> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getAuthorPeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getAuthorPeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getAuthorPeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getAuthorPeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getAuthorPeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Author> retrieveByTypedPKs(Collection<Integer> pks)
        throws TorqueException
    {
        return getAuthorPeerImpl().retrieveByTypedPKs(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Author> retrieveByTypedPKs(
                Collection<Integer> pks,
                Connection dbcon)
            throws TorqueException
    {
        return getAuthorPeerImpl().retrieveByTypedPKs(pks, dbcon);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Author> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getAuthorPeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Author> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getAuthorPeerImpl().retrieveByObjectKeys(pks, con);
    }
