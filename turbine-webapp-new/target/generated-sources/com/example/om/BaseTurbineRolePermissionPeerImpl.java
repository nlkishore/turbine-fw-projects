...
public abstract class BaseTurbineRolePermissionPeerImpl
    extends org.apache.torque.util.AbstractPeerImpl<TurbineRolePermission>
{
    /** Serial version */
    private static final long serialVersionUID = 1769038745672L;
        ...
        throws TorqueException
    {
...

        {
            JdbcTypedValue pkValue
                = columnValues.remove(TurbineRolePermissionPeer.ROLE_ID);
            if (pkValue == null)
            {
        ...
        {
            JdbcTypedValue pkValue
                = columnValues.remove(TurbineRolePermissionPeer.PERMISSION_ID);
            if (pkValue == null)
            {
                throw new TorqueException(
                        "The value for the primary key column "
            ...
            Connection con) throws TorqueException
    {
        ...
        TurbineRolePermission v = doSelectSingleRecord(criteria, con);
        if (v == null)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<TurbineRolePermission> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<TurbineRolePermission> result = retrieveByObjectKeys(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<TurbineRolePermission> retrieveByObjectKeys(
        ...
        throws TorqueException
    {
        ...
        addSelectColumns(criteria);
        com.example.om.TurbinePermissionPeer.addSelectColumns(criteria);
        ...
        criteria.addJoin(TurbineRolePermissionPeer.PERMISSION_ID,
            com.example.om.TurbinePermissionPeer.PERMISSION_ID);
        ...
        for (List<Object> rawResultRow : rawResult)
        {
            ...
            {
                TurbineRolePermission temp_obj1 = result.get(j);
                com.example.om.TurbinePermission temp_obj2 = temp_obj1.getTurbinePermission();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTurbineRolePermission(obj1);
