...
{
    /** Serial version */
    private static final long serialVersionUID = 1769038744631L;
    ...
    public List<TurbineUserGroupRole> getTurbineUserGroupRoles(Criteria criteria) throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineUserGroupRolePeer.USER_ID, getEntityId());
                collTurbineUserGroupRoles = com.example.om.TurbineUserGroupRolePeer.doSelect(criteria);
                for (TurbineUserGroupRole turbineUserGroupRole : collTurbineUserGroupRoles)
                {
                    turbineUserGroupRole.setTurbineUser((TurbineUser) this);
                }
            ...
            throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineUserGroupRolePeer.USER_ID, getEntityId());
                collTurbineUserGroupRoles = com.example.om.TurbineUserGroupRolePeer.doSelect(criteria, con);
                for (TurbineUserGroupRole turbineUserGroupRole : collTurbineUserGroupRoles)
                {
                    turbineUserGroupRole.setTurbineUser((TurbineUser) this);
                }
        ...
        throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineUserGroupRolePeer.USER_ID, getEntityId());
                collTurbineUserGroupRoles = com.example.om.TurbineUserGroupRolePeer.doSelectJoinTurbineGroup(criteria, connection);
                for (TurbineUserGroupRole turbineUserGroupRole : collTurbineUserGroupRoles)
                {
                    turbineUserGroupRole.setTurbineUser((TurbineUser) this);
                }
        ...
        throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineUserGroupRolePeer.USER_ID, getEntityId());
                collTurbineUserGroupRoles = com.example.om.TurbineUserGroupRolePeer.doSelectJoinTurbineRole(criteria, connection);
                for (TurbineUserGroupRole turbineUserGroupRole : collTurbineUserGroupRoles)
                {
                    turbineUserGroupRole.setTurbineUser((TurbineUser) this);
                }
    ...
    {
        if (com.example.om.TurbineUserPeer.USER_ID.getSqlExpression().equals(name)
            || com.example.om.TurbineUserPeer.USER_ID.getColumnName().equals(name))
        {
            return getEntityId();
        }
        if (com.example.om.TurbineUserPeer.LOGIN_NAME.getSqlExpression().equals(name)
            || com.example.om.TurbineUserPeer.LOGIN_NAME.getColumnName().equals(name))
        {
            return getEntityName();
        }
        if (com.example.om.TurbineUserPeer.PASSWORD_VALUE.getSqlExpression().equals(name)
            || com.example.om.TurbineUserPeer.PASSWORD_VALUE.getColumnName().equals(name))
        {
            return getPassword();
        }
        if (com.example.om.TurbineUserPeer.FIRST_NAME.getSqlExpression().equals(name)
            || com.example.om.TurbineUserPeer.FIRST_NAME.getColumnName().equals(name))
        {
            return getFirstName();
        }
        if (com.example.om.TurbineUserPeer.LAST_NAME.getSqlExpression().equals(name)
            || com.example.om.TurbineUserPeer.LAST_NAME.getColumnName().equals(name))
        {
            return getLastName();
        }
        if (com.example.om.TurbineUserPeer.EMAIL.getSqlExpression().equals(name)
            || com.example.om.TurbineUserPeer.EMAIL.getColumnName().equals(name))
        {
            return getEmail();
        }
        if (com.example.om.TurbineUserPeer.CONFIRM_VALUE.getSqlExpression().equals(name)
            || com.example.om.TurbineUserPeer.CONFIRM_VALUE.getColumnName().equals(name))
        {
            return getConfirmed();
        }
        if (com.example.om.TurbineUserPeer.MODIFIED_DATE.getSqlExpression().equals(name)
            || com.example.om.TurbineUserPeer.MODIFIED_DATE.getColumnName().equals(name))
        {
            return getModifiedDate();
        }
        if (com.example.om.TurbineUserPeer.CREATED.getSqlExpression().equals(name)
            || com.example.om.TurbineUserPeer.CREATED.getColumnName().equals(name))
        {
            return getCreateDate();
        }
        if (com.example.om.TurbineUserPeer.LAST_LOGIN.getSqlExpression().equals(name)
            || com.example.om.TurbineUserPeer.LAST_LOGIN.getColumnName().equals(name))
        {
            return getLastLogin();
        }
        if (com.example.om.TurbineUserPeer.OBJECTDATA.getSqlExpression().equals(name)
            || com.example.om.TurbineUserPeer.OBJECTDATA.getColumnName().equals(name))
        {
            return getObjectdata();
        }
        return null;
    ...
    /** The Peer class */
    private static final com.example.om.TurbineUserPeer peer
            = new com.example.om.TurbineUserPeer();
     ...
     */
    public com.example.om.TurbineUserPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.example.om.TurbineUserPeer.getTableMap();
    }
