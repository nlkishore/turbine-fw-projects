...
public abstract class BaseTurbineRole extends org.apache.fulcrum.security.torque.turbine.DefaultAbstractTurbineRole
    implements Persistent, Serializable, ColumnAccessByName
{
    /** Serial version */
    private static final long serialVersionUID = 1769038744382L;
     ...
     * Otherwise if this BaseTurbineRole has previously
     * been saved, it will retrieve related collTurbineRolePermissions from storage.
     * If this BaseTurbineRole is new, it will return
    ...
    public List<TurbineRolePermission> getTurbineRolePermissions(Criteria criteria) throws TorqueException
    {
        if (collTurbineRolePermissions == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineRolePermissionPeer.ROLE_ID, getEntityId());
                collTurbineRolePermissions = com.example.om.TurbineRolePermissionPeer.doSelect(criteria);
                for (TurbineRolePermission turbineRolePermission : collTurbineRolePermissions)
                {
                    turbineRolePermission.setTurbineRole((TurbineRole) this);
                }
            ...
            throws TorqueException
    {
        if (collTurbineRolePermissions == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineRolePermissionPeer.ROLE_ID, getEntityId());
                collTurbineRolePermissions = com.example.om.TurbineRolePermissionPeer.doSelect(criteria, con);
                for (TurbineRolePermission turbineRolePermission : collTurbineRolePermissions)
                {
                    turbineRolePermission.setTurbineRole((TurbineRole) this);
                }
    ...
    public List<TurbineUserGroupRole> getTurbineUserGroupRoles(Criteria criteria) throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineUserGroupRolePeer.ROLE_ID, getEntityId());
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this BaseTurbineRole is new, it will return
    ...
    protected List<TurbineRolePermission> getTurbineRolePermissionsJoinTurbinePermission(Criteria criteria) throws TorqueException
    {
        ...
        {
            List<TurbineRolePermission> result = getTurbineRolePermissionsJoinTurbinePermission(criteria, connection);
     ...
     * an identical criteria, it returns the collection.
     * Otherwise if this BaseTurbineRole is new, it will return
     * an empty collection; or if this BaseTurbineRole has previously
     * been saved, it will retrieve the related objects from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can change the access modifier to public
     * by overriding this method in the child class.
     */
    protected List<TurbineRolePermission> getTurbineRolePermissionsJoinTurbinePermission(Criteria criteria, Connection connection)
        throws TorqueException
    {
        if (collTurbineRolePermissions == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineRolePermissionPeer.ROLE_ID, getEntityId());
                collTurbineRolePermissions = com.example.om.TurbineRolePermissionPeer.doSelectJoinTurbinePermission(criteria, connection);
                for (TurbineRolePermission turbineRolePermission : collTurbineRolePermissions)
                {
                    turbineRolePermission.setTurbineRole((TurbineRole) this);
                }
        ...
        throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineUserGroupRolePeer.ROLE_ID, getEntityId());
                collTurbineUserGroupRoles = com.example.om.TurbineUserGroupRolePeer.doSelectJoinTurbineUser(criteria, connection);
                for (TurbineUserGroupRole turbineUserGroupRole : collTurbineUserGroupRoles)
                {
                    turbineUserGroupRole.setTurbineRole((TurbineRole) this);
                }
    ...
    {
        if (com.example.om.TurbineRolePeer.ROLE_ID.getSqlExpression().equals(name)
            || com.example.om.TurbineRolePeer.ROLE_ID.getColumnName().equals(name))
        {
            return getEntityId();
        }
        if (com.example.om.TurbineRolePeer.ROLE_NAME.getSqlExpression().equals(name)
            || com.example.om.TurbineRolePeer.ROLE_NAME.getColumnName().equals(name))
        {
            return getEntityName();
        }
        return null;
    ...
    public TurbineRole copy(boolean deepcopy) throws TorqueException
    {
        ...
        return copyInto(turbineRole, deepcopy);
    }
    ...
    public TurbineRole copy(boolean deepcopy, Connection con) throws TorqueException
    {
        ...
        return copyInto(turbineRole, deepcopy, con);
    }
    ...
    /** The Peer class */
    private static final com.example.om.TurbineRolePeer peer
            = new com.example.om.TurbineRolePeer();
     ...
     */
    public com.example.om.TurbineRolePeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.example.om.TurbineRolePeer.getTableMap();
    }
