...
{
    /** Serial version */
    private static final long serialVersionUID = 1769038745753L;
        ...
        throws TorqueException
    {
        ...
        com.example.om.TurbineUserPeer.addSelectColumns(criteria);
        ...
        criteria.addJoin(TurbineUserGroupRolePeer.USER_ID,
            com.example.om.TurbineUserPeer.USER_ID);
        ...
        for (List<Object> rawResultRow : rawResult)
        {
            ...
            for (int j = 0; j < result.size(); j++)
            {
                ...
                com.example.om.TurbineUser temp_obj2 = temp_obj1.getTurbineUser();
        ...
        throws TorqueException
    {
        ...
        addSelectColumns(criteria);
        com.example.om.TurbineGroupPeer.addSelectColumns(criteria);
        ...
        criteria.addJoin(TurbineUserGroupRolePeer.GROUP_ID,
            com.example.om.TurbineGroupPeer.GROUP_ID);
        ...
        for (List<Object> rawResultRow : rawResult)
        {
            ...
            {
                TurbineUserGroupRole temp_obj1 = result.get(j);
                com.example.om.TurbineGroup temp_obj2 = temp_obj1.getTurbineGroup();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTurbineUserGroupRole(obj1);
        ...
        throws TorqueException
    {
        ...
        addSelectColumns(criteria);
        com.example.om.TurbineRolePeer.addSelectColumns(criteria);
        ...
        criteria.addJoin(TurbineUserGroupRolePeer.ROLE_ID,
            com.example.om.TurbineRolePeer.ROLE_ID);
        ...
        for (List<Object> rawResultRow : rawResult)
        {
            ...
            {
                TurbineUserGroupRole temp_obj1 = result.get(j);
                com.example.om.TurbineRole temp_obj2 = temp_obj1.getTurbineRole();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTurbineUserGroupRole(obj1);
        ...
        throws TorqueException
    {
        ...
        com.example.om.TurbineGroupPeer.addSelectColumns(criteria);
        criteria.addJoin(TurbineUserGroupRolePeer.GROUP_ID, com.example.om.TurbineGroupPeer.GROUP_ID);
        compositeMapper.addMapper(new TurbineGroupRecordMapper(), offset);
        offset = offset + com.example.om.TurbineGroupPeer.numColumns;
 
        com.example.om.TurbineRolePeer.addSelectColumns(criteria);
        criteria.addJoin(TurbineUserGroupRolePeer.ROLE_ID, com.example.om.TurbineRolePeer.ROLE_ID);
        compositeMapper.addMapper(new TurbineRoleRecordMapper(), offset);
        offset = offset + com.example.om.TurbineRolePeer.numColumns;
        ...
        for (List<Object> rawResultRow : rawResult)
        {
            ...
            com.example.om.TurbineGroup obj1 = (com.example.om.TurbineGroup) rawResultRow.get(1);
            boolean newObject = true;
            for (int j = 0; j < result.size(); j++)
            {
                com.example.om.TurbineUserGroupRole temp_turbineUserGroupRole = result.get(j);
                com.example.om.TurbineGroup temp_obj1 = temp_turbineUserGroupRole.getTurbineGroup();
            ...
            com.example.om.TurbineRole obj2 = (com.example.om.TurbineRole) rawResultRow.get(2);
            newObject = true;
            for (int j = 0; j < result.size(); j++)
            {
                com.example.om.TurbineUserGroupRole temp_turbineUserGroupRole = result.get(j);
                com.example.om.TurbineRole temp_obj2 = temp_turbineUserGroupRole.getTurbineRole();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
        ...
        throws TorqueException
    {
        ...
        com.example.om.TurbineUserPeer.addSelectColumns(criteria);
        criteria.addJoin(TurbineUserGroupRolePeer.USER_ID, com.example.om.TurbineUserPeer.USER_ID);
        compositeMapper.addMapper(new TurbineUserRecordMapper(), offset);
        offset = offset + com.example.om.TurbineUserPeer.numColumns;
        ...
        for (List<Object> rawResultRow : rawResult)
        {
            ...
            com.example.om.TurbineUser obj1 = (com.example.om.TurbineUser) rawResultRow.get(1);
            boolean newObject = true;
            for (int j = 0; j < result.size(); j++)
            {
                com.example.om.TurbineUserGroupRole temp_turbineUserGroupRole = result.get(j);
                com.example.om.TurbineUser temp_obj1 = temp_turbineUserGroupRole.getTurbineUser();
                if (temp_obj1.getPrimaryKey().equals(obj1.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj1.addTurbineUserGroupRole(turbineUserGroupRole);
        ...
        throws TorqueException
    {
        ...
        for (List<Object> rawResultRow : rawResult)
        {
            ...
            com.example.om.TurbineGroup obj2 = (com.example.om.TurbineGroup) rawResultRow.get(2);
            newObject = true;
            for (int j = 0; j < result.size(); j++)
            {
                com.example.om.TurbineUserGroupRole temp_turbineUserGroupRole = result.get(j);
                com.example.om.TurbineGroup temp_obj2 = temp_turbineUserGroupRole.getTurbineGroup();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTurbineUserGroupRole(turbineUserGroupRole);
