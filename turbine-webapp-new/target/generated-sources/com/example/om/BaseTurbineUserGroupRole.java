...
{
    /** Serial version */
    private static final long serialVersionUID = 1769038744813L;
    ...
    public void setUserId(int v)
    {
        ...
        this.userId = v;
        if (aTurbineUser != null && !Objects.equals(aTurbineUser.getEntityId(), v))
        {
            aTurbineUser = null;
        }
    ...
    public void setGroupId(int v)
    {
        ...
        this.groupId = v;
        if (aTurbineGroup != null && !Objects.equals(aTurbineGroup.getEntityId(), v))
        {
            aTurbineGroup = null;
        }
        ...
        throws TorqueException
    {
        ...
        {
            aTurbineUser = com.example.om.TurbineUserPeer.retrieveByPK(SimpleKey.keyFor(this.userId));
        }
        return aTurbineUser;
    }
     ...
     * @return the associated TurbineUser object
     * @throws TorqueException If a problem occurs with the get[TurbineUser] method.
     */
        ...
        throws TorqueException
    {
        if (aTurbineUser == null && this.userId != 0)
        {
            aTurbineUser = com.example.om.TurbineUserPeer.retrieveByPK(SimpleKey.keyFor(this.userId), connection);
        }
        return aTurbineUser;
    }
        ...
        throws TorqueException
    {
        ...
        {
            aTurbineGroup = com.example.om.TurbineGroupPeer.retrieveByPK(SimpleKey.keyFor(this.groupId));
        }
     ...
     *        from the database, if it was not retrieved before
     * @return the associated TurbineGroup object
     * @throws TorqueException If a problem occurs with the get[TurbineGroup] method.
     */
        ...
        throws TorqueException
    {
        if (aTurbineGroup == null && this.groupId != 0)
        {
            aTurbineGroup = com.example.om.TurbineGroupPeer.retrieveByPK(SimpleKey.keyFor(this.groupId), connection);
        }
        return aTurbineGroup;
    }
        ...
        throws TorqueException
    {
        ...
        {
            aTurbineRole = com.example.om.TurbineRolePeer.retrieveByPK(SimpleKey.keyFor(this.roleId));
        }
        return aTurbineRole;
    }
        ...
        throws TorqueException
    {
        if (aTurbineRole == null && this.roleId != 0)
        {
            aTurbineRole = com.example.om.TurbineRolePeer.retrieveByPK(SimpleKey.keyFor(this.roleId), connection);
        }
        return aTurbineRole;
    }
    ...
    {
        if (com.example.om.TurbineUserGroupRolePeer.USER_ID.getSqlExpression().equals(name)
            || com.example.om.TurbineUserGroupRolePeer.USER_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getUserId());
        }
        if (com.example.om.TurbineUserGroupRolePeer.GROUP_ID.getSqlExpression().equals(name)
            || com.example.om.TurbineUserGroupRolePeer.GROUP_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getGroupId());
        }
        if (com.example.om.TurbineUserGroupRolePeer.ROLE_ID.getSqlExpression().equals(name)
            || com.example.om.TurbineUserGroupRolePeer.ROLE_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getRoleId());
        }
        return null;
    ...
    /** The Peer class */
    private static final com.example.om.TurbineUserGroupRolePeer peer
            = new com.example.om.TurbineUserGroupRolePeer();
     ...
     */
    public com.example.om.TurbineUserGroupRolePeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.example.om.TurbineUserGroupRolePeer.getTableMap();
    }
