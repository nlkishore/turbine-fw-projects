...
{
    /** Serial version */
    private static final long serialVersionUID = 1769038744552L;
        ...
        throws TorqueException
    {
        ...
        {
            aTurbinePermission = com.example.om.TurbinePermissionPeer.retrieveByPK(SimpleKey.keyFor(this.permissionId));
        }
        ...
        throws TorqueException
    {
        if (aTurbinePermission == null && this.permissionId != 0)
        {
            aTurbinePermission = com.example.om.TurbinePermissionPeer.retrieveByPK(SimpleKey.keyFor(this.permissionId), connection);
        }
        return aTurbinePermission;
    }
    ...
    {
        if (com.example.om.TurbineRolePermissionPeer.ROLE_ID.getSqlExpression().equals(name)
            || com.example.om.TurbineRolePermissionPeer.ROLE_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getRoleId());
        }
        if (com.example.om.TurbineRolePermissionPeer.PERMISSION_ID.getSqlExpression().equals(name)
            || com.example.om.TurbineRolePermissionPeer.PERMISSION_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getPermissionId());
        }
        return null;
    ...
    /** The Peer class */
    private static final com.example.om.TurbineRolePermissionPeer peer
            = new com.example.om.TurbineRolePermissionPeer();
     ...
     */
    public com.example.om.TurbineRolePermissionPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.example.om.TurbineRolePermissionPeer.getTableMap();
    }
