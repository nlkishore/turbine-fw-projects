...
public abstract class BaseTurbineGroupPeer
{
    ...
    private static TurbineGroupPeerImpl turbineGroupPeerImpl;
    ...
    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("kishore")
                .getDatabaseMap();
        if (dbMap.getTable("TURBINE_GROUP") == null)
        {
            dbMap.addTable("TURBINE_GROUP");
        }
        DATABASE_NAME = "kishore";
        TABLE_NAME = "TURBINE_GROUP";

        TABLE = dbMap.getTable("TURBINE_GROUP");
        TABLE.setJavaName("TurbineGroup");
        TABLE.setOMClass(com.example.om.TurbineGroup.class);
        TABLE.setPeerClass(com.example.om.TurbineGroupPeer.class);
        TABLE.setPrimaryKeyMethod(IDMethod.NATIVE);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "TURBINE_GROUP_SEQ");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "TURBINE_GROUP");
     ...
     */
    protected static TurbineGroupPeerImpl createTurbineGroupPeerImpl()
    {
        TurbineGroupPeerImpl instance = new TurbineGroupPeerImpl();
        return instance;
    }
     ...
     */
    public static TurbineGroupPeerImpl getTurbineGroupPeerImpl()
    {
        TurbineGroupPeerImpl peerImplInstance = turbineGroupPeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = TurbineGroupPeer.createTurbineGroupPeerImpl();
            turbineGroupPeerImpl = peerImplInstance;
            Torque.registerPeerInstance(TurbineGroup.class, peerImplInstance);
        }
     ...
     */
    public static void setTurbineGroupPeerImpl(TurbineGroupPeerImpl peerImplInstance)
    {
        turbineGroupPeerImpl = peerImplInstance;
    }
    ...
    {
        getTurbineGroupPeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getTurbineGroupPeerImpl().correctBooleans(criteria);
    }
    ...
    {
        getTurbineGroupPeerImpl().correctBooleans(columnValues);
    }
    ...
    public static List<TurbineGroup> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TurbineGroup> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doSelect(criteria, connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<TurbineGroup> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getTurbineGroupPeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getTurbineGroupPeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    public static List<TurbineGroup> doSelect(TurbineGroup obj)
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doSelect(obj);
    }
     ...
     */
    public static TurbineGroup doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static TurbineGroup doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    public static TurbineGroup doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static TurbineGroup getDbObjectInstance()
    {
        return getTurbineGroupPeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TurbineGroup obj)
            throws TorqueException
    {
        getTurbineGroupPeerImpl().doInsert(obj);
    }
    ...
    public static void doInsert(TurbineGroup obj, Connection con)
            throws TorqueException
    {
        getTurbineGroupPeerImpl().doInsert(obj, con);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    {
        return getTurbineGroupPeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getTurbineGroupPeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(TurbineGroup obj) throws TorqueException
    {
        return getTurbineGroupPeerImpl().doUpdate(obj);
    }
     ...
     * otherwise the doUpdate(TurbineGroup) method can be used.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use, not null.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(TurbineGroup obj, Connection con)
        throws TorqueException
    {
        return getTurbineGroupPeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getTurbineGroupPeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getTurbineGroupPeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(TurbineGroup obj) throws TorqueException
    {
        return getTurbineGroupPeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(TurbineGroup obj, Connection con)
        throws TorqueException
    {
        return getTurbineGroupPeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<TurbineGroup> objects)
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
        ...
        throws TorqueException
    {
        return getTurbineGroupPeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getTurbineGroupPeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey<?> pk, Connection con)
        throws TorqueException
    {
        return getTurbineGroupPeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getTurbineGroupPeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getTurbineGroupPeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<TurbineGroup> objects)
    {
        return getTurbineGroupPeerImpl().buildPkCriteria(objects);
    }
    ...
    {
        return getTurbineGroupPeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(TurbineGroup obj)
    {
        return getTurbineGroupPeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(TurbineGroup turbineGroup)
            throws TorqueException
    {
        
        return getTurbineGroupPeerImpl().buildColumnValues(turbineGroup);
    }
    ...
    {
        return getTurbineGroupPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TurbineGroup retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getTurbineGroupPeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TurbineGroup> retrieveByTypedPKs(Collection<Integer> pks)
        throws TorqueException
    {
        return getTurbineGroupPeerImpl().retrieveByTypedPKs(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TurbineGroup> retrieveByTypedPKs(
                Collection<Integer> pks,
                Connection dbcon)
            throws TorqueException
    {
        return getTurbineGroupPeerImpl().retrieveByTypedPKs(pks, dbcon);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TurbineGroup> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getTurbineGroupPeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TurbineGroup> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getTurbineGroupPeerImpl().retrieveByObjectKeys(pks, con);
    }
    ...
    public static void setAndSaveTurbineUserGroupRoles(
        ...
        throws TorqueException
    {
        getTurbineGroupPeerImpl().setAndSaveTurbineUserGroupRoles(toLinkTo, toSave);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getTurbineGroupPeerImpl().getTableMap();
    }
