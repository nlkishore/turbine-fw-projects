...
{
    /** Serial version */
    private static final long serialVersionUID = 1769032726169L;
    ...
    public List<TurbineRolePermission> getTurbineRolePermissions(Criteria criteria) throws TorqueException
    {
        if (collTurbineRolePermissions == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineRolePermissionPeer.PERMISSION_ID, getEntityId());
        ...
        throws TorqueException
    {
        if (collTurbineRolePermissions == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineRolePermissionPeer.PERMISSION_ID, getEntityId());
                collTurbineRolePermissions = com.example.om.TurbineRolePermissionPeer.doSelectJoinTurbineRole(criteria, connection);
                for (TurbineRolePermission turbineRolePermission : collTurbineRolePermissions)
                {
                    turbineRolePermission.setTurbinePermission((TurbinePermission) this);
                }
    ...
    {
        if (com.example.om.TurbinePermissionPeer.PERMISSION_ID.getSqlExpression().equals(name)
            || com.example.om.TurbinePermissionPeer.PERMISSION_ID.getColumnName().equals(name))
        {
            return getEntityId();
        }
        if (com.example.om.TurbinePermissionPeer.PERMISSION_NAME.getSqlExpression().equals(name)
            || com.example.om.TurbinePermissionPeer.PERMISSION_NAME.getColumnName().equals(name))
        {
            return getEntityName();
        }
        return null;
    ...
    /** The Peer class */
    private static final com.example.om.TurbinePermissionPeer peer
            = new com.example.om.TurbinePermissionPeer();
     ...
     */
    public com.example.om.TurbinePermissionPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.example.om.TurbinePermissionPeer.getTableMap();
    }
