...
{
    /** Serial version */
    private static final long serialVersionUID = 1769032726392L;
    ...
    public List<TurbineUserGroupRole> getTurbineUserGroupRoles(Criteria criteria) throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(com.example.om.TurbineUserGroupRolePeer.GROUP_ID, getEntityId());
    ...
    {
        if (com.example.om.TurbineGroupPeer.GROUP_ID.getSqlExpression().equals(name)
            || com.example.om.TurbineGroupPeer.GROUP_ID.getColumnName().equals(name))
        {
            return getEntityId();
        }
        if (com.example.om.TurbineGroupPeer.GROUP_NAME.getSqlExpression().equals(name)
            || com.example.om.TurbineGroupPeer.GROUP_NAME.getColumnName().equals(name))
        {
            return getEntityName();
        }
        return null;
    ...
    /** The Peer class */
    private static final com.example.om.TurbineGroupPeer peer
            = new com.example.om.TurbineGroupPeer();
     ...
     */
    public com.example.om.TurbineGroupPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.example.om.TurbineGroupPeer.getTableMap();
    }
