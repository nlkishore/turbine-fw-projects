...
{
    /** Serial version */
    private static final long serialVersionUID = 1769032725687L;
    ...
    /**
     * Method called to reset the cache of Book objects
     * which are related through the collBooks foreign key attribute.
     */
     ...
     */
    private transient Criteria lastBookCriteria = null;
    ...
    public List<Book> getBooks(Criteria criteria) throws TorqueException
    {
        if (collBooks == null)
        {
            ...
            {
                criteria.and(com.example.om.BookPeer.AUTH_ID, getAuthId());
                collBooks = com.example.om.BookPeer.doSelect(criteria);
                for (Book book : collBooks)
                {
                    book.setAuthor((Author) this);
                }
     ...
     * @return List<Book> results of the collection
            ...
            throws TorqueException
    {
        if (collBooks == null)
        {
            ...
            {
                criteria.and(com.example.om.BookPeer.AUTH_ID, getAuthId());
                collBooks = com.example.om.BookPeer.doSelect(criteria, con);
                for (Book book : collBooks)
                {
                    book.setAuthor((Author) this);
                }
    ...
    {
        if (com.example.om.AuthorPeer.AUTH_ID.getSqlExpression().equals(name)
            || com.example.om.AuthorPeer.AUTH_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getAuthId());
        }
        if (com.example.om.AuthorPeer.FIRST_NAME.getSqlExpression().equals(name)
            || com.example.om.AuthorPeer.FIRST_NAME.getColumnName().equals(name))
        {
            return getFirstName();
        }
        if (com.example.om.AuthorPeer.LAST_NAME.getSqlExpression().equals(name)
            || com.example.om.AuthorPeer.LAST_NAME.getColumnName().equals(name))
        {
            return getLastName();
        }
        return null;
    ...
    {
        setAuthId(Integer.parseInt(key));
    }
    ...
    {
        return SimpleKey.keyFor(getAuthId());
    }
    ...
    /** The Peer class */
    private static final com.example.om.AuthorPeer peer
            = new com.example.om.AuthorPeer();
     ...
     */
    public com.example.om.AuthorPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.example.om.AuthorPeer.getTableMap();
    }
