...
public abstract class BaseGtpUserGroupRolePeer
{
    ...
    private static GtpUserGroupRolePeerImpl gtpUserGroupRolePeerImpl;


    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("gtp")
                .getDatabaseMap();
        if (dbMap.getTable("GTP_USER_GROUP_ROLE") == null)
        {
            dbMap.addTable("GTP_USER_GROUP_ROLE");
        }
        DATABASE_NAME = "gtp";
        TABLE_NAME = "GTP_USER_GROUP_ROLE";

        TABLE = dbMap.getTable("GTP_USER_GROUP_ROLE");
        TABLE.setJavaName("GtpUserGroupRole");
        TABLE.setOMClass(com.example.om.GtpUserGroupRole.class);
        TABLE.setPeerClass(com.example.om.GtpUserGroupRolePeer.class);
        TABLE.setPrimaryKeyMethod(IDMethod.NO_ID_METHOD);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "$sequenceName");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "GTP_USER_GROUP_ROLE");
     ...
     */
    protected static GtpUserGroupRolePeerImpl createGtpUserGroupRolePeerImpl()
    {
        GtpUserGroupRolePeerImpl instance = new GtpUserGroupRolePeerImpl();
        return instance;
    }
     ...
     */
    public static GtpUserGroupRolePeerImpl getGtpUserGroupRolePeerImpl()
    {
        GtpUserGroupRolePeerImpl peerImplInstance = gtpUserGroupRolePeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = GtpUserGroupRolePeer.createGtpUserGroupRolePeerImpl();
            gtpUserGroupRolePeerImpl = peerImplInstance;
            Torque.registerPeerInstance(GtpUserGroupRole.class, peerImplInstance);
        }
     ...
     */
    public static void setGtpUserGroupRolePeerImpl(GtpUserGroupRolePeerImpl peerImplInstance)
    {
        gtpUserGroupRolePeerImpl = peerImplInstance;
    }
    ...
    {
        getGtpUserGroupRolePeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getGtpUserGroupRolePeerImpl().correctBooleans(criteria);
    }
    ...
    {
        getGtpUserGroupRolePeerImpl().correctBooleans(columnValues);
    }
    
    /**
     * Selects GtpUserGroupRole objects from a database.
     *
     ...
     */
    public static List<GtpUserGroupRole> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUserGroupRole> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelect(criteria, connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<GtpUserGroupRole> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    /**
     * Selects GtpUserGroupRole objects from the database which have
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUserGroupRole> doSelect(GtpUserGroupRole obj)
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelect(obj);
    }

    /**
     * Selects at most one GtpUserGroupRole object from a database.
     *
     * @param criteria object used to create the SELECT statement.
     *
     ...
     */
    public static GtpUserGroupRole doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static GtpUserGroupRole doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    /**
     * Selects at most one GtpUserGroupRole object from the database
     ...
     */
    public static GtpUserGroupRole doSelectSingleRecord(
                GtpUserGroupRole obj)
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static GtpUserGroupRole getDbObjectInstance()
    {
        return getGtpUserGroupRolePeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpUserGroupRole obj)
            throws TorqueException
    {
        getGtpUserGroupRolePeerImpl().doInsert(obj);
    }

    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(GtpUserGroupRole) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpUserGroupRole obj, Connection con)
            throws TorqueException
    {
        getGtpUserGroupRolePeerImpl().doInsert(obj, con);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    {
        return getGtpUserGroupRolePeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
    ...
    /**
     * Updates an GtpUserGroupRole in the database.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpUserGroupRole obj) throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doUpdate(obj);
    }

    /**
     * Updates a GtpUserGroupRole in the database.
     * The primary key is used to identify the object to update.
     * This method is to be used during a transaction,
     * otherwise the doUpdate(GtpUserGroupRole) method can be used.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use, not null.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpUserGroupRole obj, Connection con)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getGtpUserGroupRolePeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getGtpUserGroupRolePeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpUserGroupRole obj) throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpUserGroupRole obj, Connection con)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<GtpUserGroupRole> objects)
            throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
        ...
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getGtpUserGroupRolePeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey<?> pk, Connection con)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getGtpUserGroupRolePeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getGtpUserGroupRolePeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<GtpUserGroupRole> objects)
    {
        return getGtpUserGroupRolePeerImpl().buildPkCriteria(objects);
    }
     ...
     */
    public static Criteria buildCriteria(GtpUserGroupRole obj)
    {
        return getGtpUserGroupRolePeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(GtpUserGroupRole obj)
    {
        return getGtpUserGroupRolePeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(GtpUserGroupRole gtpUserGroupRole)
            throws TorqueException
    {
        
        return getGtpUserGroupRolePeerImpl().buildColumnValues(gtpUserGroupRole);
    }
     ...
     * @param roleId int
     */
    public static GtpUserGroupRole retrieveByPK(
            int userId,
            int groupId,
            int roleId)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().retrieveByPK(
                userId,
                groupId,
                roleId);
    }
     ...
     */
    public static GtpUserGroupRole retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpUserGroupRolePeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpUserGroupRole retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpUserGroupRolePeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUserGroupRole> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUserGroupRole> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().retrieveByObjectKeys(pks, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUserGroupRole> doSelectJoinGtpUser(Criteria criteria)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinGtpUser(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUserGroupRole> doSelectJoinGtpUser(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinGtpUser(criteria, conn);
    }
    /**
     * Selects a collection of dbObjectClassName objects pre-filled with their
     * GtpGroup objects.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUserGroupRole> doSelectJoinGtpGroup(Criteria criteria)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinGtpGroup(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUserGroupRole> doSelectJoinGtpGroup(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinGtpGroup(criteria, conn);
    }
    /**
     * Selects a collection of dbObjectClassName objects pre-filled with their
     * GtpRole objects.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUserGroupRole> doSelectJoinGtpRole(Criteria criteria)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinGtpRole(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUserGroupRole> doSelectJoinGtpRole(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinGtpRole(criteria, conn);
    }
     ...
     * actually need in GtpUserGroupRolePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<GtpUserGroupRole> doSelectJoinAllExceptGtpUser(Criteria criteria)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinAllExceptGtpUser(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<GtpUserGroupRole> doSelectJoinAllExceptGtpUser(Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinAllExceptGtpUser(criteria, conn);
    }
    /**
     * selects a collection of GtpUserGroupRole objects pre-filled with
     * all related objects.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<GtpUserGroupRole> doSelectJoinAllExceptGtpGroup(Criteria criteria)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinAllExceptGtpGroup(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<GtpUserGroupRole> doSelectJoinAllExceptGtpGroup(Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinAllExceptGtpGroup(criteria, conn);
    }
    /**
     * selects a collection of GtpUserGroupRole objects pre-filled with
     * all related objects.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<GtpUserGroupRole> doSelectJoinAllExceptGtpRole(Criteria criteria)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinAllExceptGtpRole(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<GtpUserGroupRole> doSelectJoinAllExceptGtpRole(Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().doSelectJoinAllExceptGtpRole(criteria, conn);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getGtpUserGroupRolePeerImpl().getTableMap();
    }
