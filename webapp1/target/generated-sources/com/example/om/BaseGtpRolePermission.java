 ...
 * extended; all references should be to GtpRolePermission
 */
@SuppressWarnings("unused")
public abstract class BaseGtpRolePermission 
    implements Persistent, Serializable, ColumnAccessByName
{
    /** Serial version */
    private static final long serialVersionUID = 1769032810866L;
    ...
    /** Defines the aGtpPermission field. */
    private GtpPermission aGtpPermission = null;
    ...
    public void setPermissionId(int v)
    {
        ...
        this.permissionId = v;
        if (aGtpPermission != null && !Objects.equals(aGtpPermission.getEntityId(), v))
        {
            aGtpPermission = null;
        }
    ...
    /**
     * Returns the associated GtpPermission object.
     * If it was not retrieved before, the object is retrieved from
     * the database
     *
     * @return the associated GtpPermission object
     * @throws TorqueException when reading from the database fails.
     */
    public GtpPermission getGtpPermission()
        throws TorqueException
    {
        if (aGtpPermission == null && this.permissionId != 0)
        {
            aGtpPermission = com.example.om.GtpPermissionPeer.retrieveByPK(SimpleKey.keyFor(this.permissionId));
        }
        return aGtpPermission;
    }
     ...
     *        from the database, if it was not retrieved before
     * @return the associated GtpPermission object
     * @throws TorqueException If a problem occurs with the get[GtpPermission] method.
     */
    public GtpPermission getGtpPermission(Connection connection)
        throws TorqueException
    {
        if (aGtpPermission == null && this.permissionId != 0)
        {
            aGtpPermission = com.example.om.GtpPermissionPeer.retrieveByPK(SimpleKey.keyFor(this.permissionId), connection);
        }
        return aGtpPermission;
    }
    ...
    /**
     * Declares an association between this object and a GtpPermission object
     *
     * @param v GtpPermission
     */
    public void setGtpPermission(GtpPermission v)
    {
        if (v == null || v.getEntityId() == null)
        {
            setPermissionId(0);
     ...
     * @throws TorqueException if associated objects are not found
     */
    public void setGtpPermissionKey(ObjectKey<?> key) throws TorqueException
    {
    ...
    {
        if (com.example.om.GtpRolePermissionPeer.ROLE_ID.getSqlExpression().equals(name)
            || com.example.om.GtpRolePermissionPeer.ROLE_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getRoleId());
        }
        if (com.example.om.GtpRolePermissionPeer.PERMISSION_ID.getSqlExpression().equals(name)
            || com.example.om.GtpRolePermissionPeer.PERMISSION_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getPermissionId());
        }
        return null;
    ...
    {
        save(GtpRolePermissionPeer.DATABASE_NAME);
    }
            ...
            throws TorqueException
    {
        ...
        try
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    GtpRolePermissionPeer.doInsert((GtpRolePermission) this, con);
                    setNew(false);
                }
                else
                {
                    GtpRolePermissionPeer.doUpdate((GtpRolePermission) this, con);
                }
            }
    ...
    /**
     * Returns an id that differentiates the referenced GtpPermission object
     * from all other GtpPermission objects.
     *
     * @return an ObjectKey.
     */
    public ObjectKey<?> getForeignKeyForGtpPermission()
    {
     ...
     */
    public GtpRolePermission copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails     
     */
    public GtpRolePermission copy(Connection con) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public GtpRolePermission copy(boolean deepcopy) throws TorqueException
    {
        GtpRolePermission gtpRolePermission = new GtpRolePermission();

        return copyInto(gtpRolePermission, deepcopy);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public GtpRolePermission copy(boolean deepcopy, Connection con) throws TorqueException
    {
        GtpRolePermission gtpRolePermission = new GtpRolePermission();

        return copyInto(gtpRolePermission, deepcopy, con);
    }
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public GtpRolePermission copyInto(GtpRolePermission copyObj) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public GtpRolePermission copyInto(GtpRolePermission copyObj, Connection con) throws TorqueException
    {
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    protected GtpRolePermission copyInto(GtpRolePermission copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setRoleId(0);
     ...
     * @throws TorqueException if retrieval of the associated objects fails
     */
    public GtpRolePermission copyInto(GtpRolePermission copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setRoleId(0);
        copyObj.setPermissionId(0);
    ...
    /** The Peer class */
    private static final com.example.om.GtpRolePermissionPeer peer
            = new com.example.om.GtpRolePermissionPeer();
     ...
     */
    public com.example.om.GtpRolePermissionPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.example.om.GtpRolePermissionPeer.getTableMap();
    }
    ...
    public boolean equals(Object toCompare)
    {
        ...
        GtpRolePermission other = (GtpRolePermission) toCompare;
     ...
     */
    public boolean valueEquals(GtpRolePermission toCompare)
    {
        if (toCompare == null)
        {
            return false;
