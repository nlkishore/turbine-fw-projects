 ...
 * extended; all references should be to GtpUserPeer
 */

@SuppressWarnings("unused")
public abstract class BaseGtpUserPeer
{
    ...
    private static GtpUserPeerImpl gtpUserPeerImpl;
    ...
    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("gtp")
                .getDatabaseMap();
        if (dbMap.getTable("GTP_USER") == null)
        {
            dbMap.addTable("GTP_USER");
        }
        DATABASE_NAME = "gtp";
        TABLE_NAME = "GTP_USER";

        TABLE = dbMap.getTable("GTP_USER");
        TABLE.setJavaName("GtpUser");
        TABLE.setOMClass(com.example.om.GtpUser.class);
        TABLE.setPeerClass(com.example.om.GtpUserPeer.class);
        TABLE.setPrimaryKeyMethod(IDMethod.NATIVE);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "GTP_USER_SEQ");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "GTP_USER");
     ...
     */
    protected static GtpUserPeerImpl createGtpUserPeerImpl()
    {
        GtpUserPeerImpl instance = new GtpUserPeerImpl();
        return instance;
    }
     ...
     */
    public static GtpUserPeerImpl getGtpUserPeerImpl()
    {
        GtpUserPeerImpl peerImplInstance = gtpUserPeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = GtpUserPeer.createGtpUserPeerImpl();
            gtpUserPeerImpl = peerImplInstance;
            Torque.registerPeerInstance(GtpUser.class, peerImplInstance);
        }
     ...
     */
    public static void setGtpUserPeerImpl(GtpUserPeerImpl peerImplInstance)
    {
        gtpUserPeerImpl = peerImplInstance;
    }
    ...
    {
        getGtpUserPeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getGtpUserPeerImpl().correctBooleans(criteria);
    }
    ...
    {
        getGtpUserPeerImpl().correctBooleans(columnValues);
    }
    
    /**
     * Selects GtpUser objects from a database.
     *
     ...
     */
    public static List<GtpUser> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getGtpUserPeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUser> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpUserPeerImpl().doSelect(criteria, connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<GtpUser> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpUserPeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getGtpUserPeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getGtpUserPeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getGtpUserPeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    /**
     * Selects GtpUser objects from the database which have
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUser> doSelect(GtpUser obj)
            throws TorqueException
    {
        return getGtpUserPeerImpl().doSelect(obj);
    }

    /**
     * Selects at most one GtpUser object from a database.
     *
     * @param criteria object used to create the SELECT statement.
     *
     ...
     */
    public static GtpUser doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getGtpUserPeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static GtpUser doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpUserPeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpUserPeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    /**
     * Selects at most one GtpUser object from the database
    ...
    public static GtpUser doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpUserPeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static GtpUser getDbObjectInstance()
    {
        return getGtpUserPeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getGtpUserPeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getGtpUserPeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpUser obj)
            throws TorqueException
    {
        getGtpUserPeerImpl().doInsert(obj);
    }

    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(GtpUser) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpUser obj, Connection con)
            throws TorqueException
    {
        getGtpUserPeerImpl().doInsert(obj, con);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpUserPeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpUserPeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpUserPeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpUserPeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    {
        return getGtpUserPeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getGtpUserPeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getGtpUserPeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
    ...
    /**
     * Updates an GtpUser in the database.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpUser obj) throws TorqueException
    {
        return getGtpUserPeerImpl().doUpdate(obj);
    }

    /**
     * Updates a GtpUser in the database.
     * The primary key is used to identify the object to update.
     * This method is to be used during a transaction,
     * otherwise the doUpdate(GtpUser) method can be used.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use, not null.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpUser obj, Connection con)
        throws TorqueException
    {
        return getGtpUserPeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getGtpUserPeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getGtpUserPeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getGtpUserPeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getGtpUserPeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpUser obj) throws TorqueException
    {
        return getGtpUserPeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpUser obj, Connection con)
        throws TorqueException
    {
        return getGtpUserPeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<GtpUser> objects)
            throws TorqueException
    {
        return getGtpUserPeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
            Collection<GtpUser> objects,
            Connection con)
        throws TorqueException
    {
        return getGtpUserPeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getGtpUserPeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey<?> pk, Connection con)
        throws TorqueException
    {
        return getGtpUserPeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getGtpUserPeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getGtpUserPeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<GtpUser> objects)
    {
        return getGtpUserPeerImpl().buildPkCriteria(objects);
    }
     ...
     */
    public static Criteria buildCriteria(GtpUser obj)
    {
        return getGtpUserPeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(GtpUser obj)
    {
        return getGtpUserPeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(GtpUser gtpUser)
            throws TorqueException
    {
        
        return getGtpUserPeerImpl().buildColumnValues(gtpUser);
    }
     ...
     */
    public static GtpUser retrieveByPK(Integer pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpUserPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpUser retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpUserPeerImpl().retrieveByPK(pk, con);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpUser retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpUserPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpUser retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpUserPeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUser> retrieveByTypedPKs(Collection<Integer> pks)
        throws TorqueException
    {
        return getGtpUserPeerImpl().retrieveByTypedPKs(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUser> retrieveByTypedPKs(
                Collection<Integer> pks,
                Connection dbcon)
            throws TorqueException
    {
        return getGtpUserPeerImpl().retrieveByTypedPKs(pks, dbcon);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUser> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getGtpUserPeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpUser> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getGtpUserPeerImpl().retrieveByObjectKeys(pks, con);
    }
    ...
    public static void setAndSaveGtpUserGroupRoles(
        ...
        throws TorqueException
    {
        getGtpUserPeerImpl().setAndSaveGtpUserGroupRoles(toLinkTo, toSave);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getGtpUserPeerImpl().getTableMap();
    }
