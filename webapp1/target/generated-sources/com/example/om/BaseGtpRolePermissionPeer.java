...
public abstract class BaseGtpRolePermissionPeer
{
    ...
    private static GtpRolePermissionPeerImpl gtpRolePermissionPeerImpl;
    ...
    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("gtp")
                .getDatabaseMap();
        if (dbMap.getTable("GTP_ROLE_PERMISSION") == null)
        {
            dbMap.addTable("GTP_ROLE_PERMISSION");
        }
        DATABASE_NAME = "gtp";
        TABLE_NAME = "GTP_ROLE_PERMISSION";

        TABLE = dbMap.getTable("GTP_ROLE_PERMISSION");
        TABLE.setJavaName("GtpRolePermission");
        TABLE.setOMClass(com.example.om.GtpRolePermission.class);
        TABLE.setPeerClass(com.example.om.GtpRolePermissionPeer.class);
        TABLE.setPrimaryKeyMethod(IDMethod.NO_ID_METHOD);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "$sequenceName");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "GTP_ROLE_PERMISSION");
    ...
    // ------------- Foreign keys --------------------
        ...
        foreignTableName = "GTP_PERMISSION"; 
        foreignTable = dbMap.getTable(foreignTableName);
        if (foreignTable == null)
        {
            foreignKeyMap = new ForeignKeyMap(TABLE, foreignTableName);
     ...
     */
    protected static GtpRolePermissionPeerImpl createGtpRolePermissionPeerImpl()
    {
        GtpRolePermissionPeerImpl instance = new GtpRolePermissionPeerImpl();
        return instance;
    }
     ...
     */
    public static GtpRolePermissionPeerImpl getGtpRolePermissionPeerImpl()
    {
        GtpRolePermissionPeerImpl peerImplInstance = gtpRolePermissionPeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = GtpRolePermissionPeer.createGtpRolePermissionPeerImpl();
            gtpRolePermissionPeerImpl = peerImplInstance;
            Torque.registerPeerInstance(GtpRolePermission.class, peerImplInstance);
        }
     ...
     */
    public static void setGtpRolePermissionPeerImpl(GtpRolePermissionPeerImpl peerImplInstance)
    {
        gtpRolePermissionPeerImpl = peerImplInstance;
    }
    ...
    {
        getGtpRolePermissionPeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getGtpRolePermissionPeerImpl().correctBooleans(criteria);
    }
    ...
    {
        getGtpRolePermissionPeerImpl().correctBooleans(columnValues);
    }
    
    /**
     * Selects GtpRolePermission objects from a database.
     *
     ...
     */
    public static List<GtpRolePermission> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRolePermission> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelect(criteria, connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<GtpRolePermission> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    /**
     * Selects GtpRolePermission objects from the database which have
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRolePermission> doSelect(GtpRolePermission obj)
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelect(obj);
    }

    /**
     * Selects at most one GtpRolePermission object from a database.
     *
     * @param criteria object used to create the SELECT statement.
     *
     ...
     */
    public static GtpRolePermission doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static GtpRolePermission doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    /**
     * Selects at most one GtpRolePermission object from the database
     ...
     */
    public static GtpRolePermission doSelectSingleRecord(
                GtpRolePermission obj)
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static GtpRolePermission getDbObjectInstance()
    {
        return getGtpRolePermissionPeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpRolePermission obj)
            throws TorqueException
    {
        getGtpRolePermissionPeerImpl().doInsert(obj);
    }

    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(GtpRolePermission) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpRolePermission obj, Connection con)
            throws TorqueException
    {
        getGtpRolePermissionPeerImpl().doInsert(obj, con);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    {
        return getGtpRolePermissionPeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
    ...
    /**
     * Updates an GtpRolePermission in the database.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpRolePermission obj) throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doUpdate(obj);
    }

    /**
     * Updates a GtpRolePermission in the database.
     * The primary key is used to identify the object to update.
     * This method is to be used during a transaction,
     * otherwise the doUpdate(GtpRolePermission) method can be used.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use, not null.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpRolePermission obj, Connection con)
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getGtpRolePermissionPeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getGtpRolePermissionPeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpRolePermission obj) throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpRolePermission obj, Connection con)
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<GtpRolePermission> objects)
            throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
        ...
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getGtpRolePermissionPeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey<?> pk, Connection con)
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getGtpRolePermissionPeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getGtpRolePermissionPeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<GtpRolePermission> objects)
    {
        return getGtpRolePermissionPeerImpl().buildPkCriteria(objects);
    }
     ...
     */
    public static Criteria buildCriteria(GtpRolePermission obj)
    {
        return getGtpRolePermissionPeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(GtpRolePermission obj)
    {
        return getGtpRolePermissionPeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(GtpRolePermission gtpRolePermission)
            throws TorqueException
    {
        
        return getGtpRolePermissionPeerImpl().buildColumnValues(gtpRolePermission);
    }
     ...
     */
    public static GtpRolePermission retrieveByPK(
            int roleId,
            int permissionId)
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().retrieveByPK(
                roleId,
                permissionId);
    }
     ...
     */
    public static GtpRolePermission retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpRolePermissionPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpRolePermission retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpRolePermissionPeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRolePermission> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRolePermission> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().retrieveByObjectKeys(pks, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRolePermission> doSelectJoinGtpRole(Criteria criteria)
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelectJoinGtpRole(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRolePermission> doSelectJoinGtpRole(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelectJoinGtpRole(criteria, conn);
    }
    /**
     * Selects a collection of dbObjectClassName objects pre-filled with their
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRolePermission> doSelectJoinGtpPermission(Criteria criteria)
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelectJoinGtpPermission(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRolePermission> doSelectJoinGtpPermission(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().doSelectJoinGtpPermission(criteria, conn);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getGtpRolePermissionPeerImpl().getTableMap();
    }
