...
INSERT INTO GTP_USER (USER_ID,LOGIN_NAME,PASSWORD_VALUE,FIRST_NAME,LAST_NAME)
...
-- 
ALTER TABLE GTP_USER MODIFY COLUMN USER_ID INT auto_increment;
ALTER TABLE GTP_PERMISSION MODIFY COLUMN PERMISSION_ID INT auto_increment;
ALTER TABLE GTP_ROLE MODIFY COLUMN ROLE_ID INT auto_increment;
ALTER TABLE GTP_GROUP MODIFY COLUMN GROUP_ID INT auto_increment;


##-- use ID_TABLE  with idMethod="idbroker" and set appropriate start_id and end_id 
##-- INSERT INTO ID_TABLE (id_table_id, table_name, next_id, quantity) VALUES (1,'GTP_USER',start_id, end_id);
