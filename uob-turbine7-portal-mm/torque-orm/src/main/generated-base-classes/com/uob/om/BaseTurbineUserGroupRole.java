...
{
    /** Serial version */
    private static final long serialVersionUID = 1769223164971L;
        ...
        throws TorqueException
    {
        ...
        {
            aTurbineUser = com.uob.om.TurbineUserPeer.retrieveByPK(SimpleKey.keyFor(this.userId));
        }
        return aTurbineUser;
    }
        ...
        throws TorqueException
    {
        if (aTurbineUser == null && this.userId != 0)
        {
            aTurbineUser = com.uob.om.TurbineUserPeer.retrieveByPK(SimpleKey.keyFor(this.userId), connection);
        }
        return aTurbineUser;
    }
        ...
        throws TorqueException
    {
        ...
        {
            aTurbineGroup = com.uob.om.TurbineGroupPeer.retrieveByPK(SimpleKey.keyFor(this.groupId));
        }
        ...
        throws TorqueException
    {
        if (aTurbineGroup == null && this.groupId != 0)
        {
            aTurbineGroup = com.uob.om.TurbineGroupPeer.retrieveByPK(SimpleKey.keyFor(this.groupId), connection);
        }
        return aTurbineGroup;
    }
    ...
    {
        if (com.uob.om.TurbineUserGroupRolePeer.USER_ID.getSqlExpression().equals(name)
            || com.uob.om.TurbineUserGroupRolePeer.USER_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getUserId());
        }
        if (com.uob.om.TurbineUserGroupRolePeer.GROUP_ID.getSqlExpression().equals(name)
            || com.uob.om.TurbineUserGroupRolePeer.GROUP_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getGroupId());
        }
        if (com.uob.om.TurbineUserGroupRolePeer.ROLE_ID.getSqlExpression().equals(name)
            || com.uob.om.TurbineUserGroupRolePeer.ROLE_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getRoleId());
        }
        return null;
    ...
    /** The Peer class */
    private static final com.uob.om.TurbineUserGroupRolePeer peer
            = new com.uob.om.TurbineUserGroupRolePeer();
     ...
     */
    public com.uob.om.TurbineUserGroupRolePeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.uob.om.TurbineUserGroupRolePeer.getTableMap();
    }
