 ...
 * extended; all references should be to GtpGroupPeer
 */

@SuppressWarnings("unused")
public abstract class BaseGtpGroupPeer
{
    ...
    private static GtpGroupPeerImpl gtpGroupPeerImpl;
    ...
    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("kishore")
                .getDatabaseMap();
        if (dbMap.getTable("GTP_GROUP") == null)
        {
            dbMap.addTable("GTP_GROUP");
        }
        DATABASE_NAME = "kishore";
        TABLE_NAME = "GTP_GROUP";

        TABLE = dbMap.getTable("GTP_GROUP");
        TABLE.setJavaName("GtpGroup");
        TABLE.setOMClass(com.uob.om.GtpGroup.class);
        TABLE.setPeerClass(com.uob.om.GtpGroupPeer.class);
        TABLE.setPrimaryKeyMethod(IDMethod.NATIVE);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "GTP_GROUP_SEQ");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "GTP_GROUP");
     ...
     */
    protected static GtpGroupPeerImpl createGtpGroupPeerImpl()
    {
        GtpGroupPeerImpl instance = new GtpGroupPeerImpl();
        return instance;
    }
     ...
     */
    public static GtpGroupPeerImpl getGtpGroupPeerImpl()
    {
        GtpGroupPeerImpl peerImplInstance = gtpGroupPeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = GtpGroupPeer.createGtpGroupPeerImpl();
            gtpGroupPeerImpl = peerImplInstance;
            Torque.registerPeerInstance(GtpGroup.class, peerImplInstance);
        }
     ...
     */
    public static void setGtpGroupPeerImpl(GtpGroupPeerImpl peerImplInstance)
    {
        gtpGroupPeerImpl = peerImplInstance;
    }
    ...
    {
        getGtpGroupPeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getGtpGroupPeerImpl().correctBooleans(criteria);
    }
    ...
    {
        getGtpGroupPeerImpl().correctBooleans(columnValues);
    }
    
    /**
     * Selects GtpGroup objects from a database.
     *
     ...
     */
    public static List<GtpGroup> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroup> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doSelect(criteria, connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<GtpGroup> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getGtpGroupPeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getGtpGroupPeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    /**
     * Selects GtpGroup objects from the database which have
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroup> doSelect(GtpGroup obj)
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doSelect(obj);
    }

    /**
     * Selects at most one GtpGroup object from a database.
     *
     * @param criteria object used to create the SELECT statement.
     *
     ...
     */
    public static GtpGroup doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static GtpGroup doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    /**
     * Selects at most one GtpGroup object from the database
    ...
    public static GtpGroup doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static GtpGroup getDbObjectInstance()
    {
        return getGtpGroupPeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpGroup obj)
            throws TorqueException
    {
        getGtpGroupPeerImpl().doInsert(obj);
    }

    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(GtpGroup) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpGroup obj, Connection con)
            throws TorqueException
    {
        getGtpGroupPeerImpl().doInsert(obj, con);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    {
        return getGtpGroupPeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getGtpGroupPeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
    ...
    /**
     * Updates an GtpGroup in the database.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpGroup obj) throws TorqueException
    {
        return getGtpGroupPeerImpl().doUpdate(obj);
    }

    /**
     * Updates a GtpGroup in the database.
     * The primary key is used to identify the object to update.
     * This method is to be used during a transaction,
     * otherwise the doUpdate(GtpGroup) method can be used.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use, not null.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpGroup obj, Connection con)
        throws TorqueException
    {
        return getGtpGroupPeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getGtpGroupPeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getGtpGroupPeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getGtpGroupPeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getGtpGroupPeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpGroup obj) throws TorqueException
    {
        return getGtpGroupPeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpGroup obj, Connection con)
        throws TorqueException
    {
        return getGtpGroupPeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<GtpGroup> objects)
            throws TorqueException
    {
        return getGtpGroupPeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
            Collection<GtpGroup> objects,
            Connection con)
        throws TorqueException
    {
        return getGtpGroupPeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getGtpGroupPeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey<?> pk, Connection con)
        throws TorqueException
    {
        return getGtpGroupPeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getGtpGroupPeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getGtpGroupPeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<GtpGroup> objects)
    {
        return getGtpGroupPeerImpl().buildPkCriteria(objects);
    }
     ...
     */
    public static Criteria buildCriteria(GtpGroup obj)
    {
        return getGtpGroupPeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(GtpGroup obj)
    {
        return getGtpGroupPeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(GtpGroup gtpGroup)
            throws TorqueException
    {
        
        return getGtpGroupPeerImpl().buildColumnValues(gtpGroup);
    }
     ...
     */
    public static GtpGroup retrieveByPK(Integer pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpGroupPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpGroup retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpGroupPeerImpl().retrieveByPK(pk, con);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpGroup retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpGroupPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpGroup retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpGroupPeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroup> retrieveByTypedPKs(Collection<Integer> pks)
        throws TorqueException
    {
        return getGtpGroupPeerImpl().retrieveByTypedPKs(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroup> retrieveByTypedPKs(
                Collection<Integer> pks,
                Connection dbcon)
            throws TorqueException
    {
        return getGtpGroupPeerImpl().retrieveByTypedPKs(pks, dbcon);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroup> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getGtpGroupPeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroup> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getGtpGroupPeerImpl().retrieveByObjectKeys(pks, con);
    }
    ...
    public static void setAndSaveGtpGroupRoles(
        ...
        throws TorqueException
    {
        getGtpGroupPeerImpl().setAndSaveGtpGroupRoles(toLinkTo, toSave);
    }
    ...
    public static void setAndSaveGtpUserGroupRoles(
        ...
        throws TorqueException
    {
        getGtpGroupPeerImpl().setAndSaveGtpUserGroupRoles(toLinkTo, toSave);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getGtpGroupPeerImpl().getTableMap();
    }
