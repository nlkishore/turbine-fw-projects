...
{
    /** Serial version */
    private static final long serialVersionUID = 1769223168997L;

    /** The class log. */
    private static Log log
            = LogFactory.getLog(BaseTurbineRolePermissionRecordMapper.class);
            
    private static final String ROLE_ID_EXPRESSION = BaseTurbineRolePermissionPeer.ROLE_ID.getSqlExpression();
    private static final String PERMISSION_ID_EXPRESSION = BaseTurbineRolePermissionPeer.PERMISSION_ID.getSqlExpression();

    private boolean useMappingStrategy = true;

    private MappingStrategy<TurbineRolePermission> strategy;
    
    public void initStrategy()
    {
        this.strategy = new MappingStrategy<TurbineRolePermission>();
    }
            ...
            else
            {
                ...
                for (Column column : columnsWithoutOffset)
                {
                            ...
                            column.getSqlExpression()))
                    {
                        ...
                        {
                            turbineRolePermission.setRoleId( getRoleId(resultSet, totalOffset));
                        }
                            ...
                            column.getSqlExpression()))
                    {
                        ...
                        {
                            turbineRolePermission.setPermissionId( getPermissionId(resultSet, totalOffset));
                        }
                ...
                if (useMappingStrategy)
                {
                  ...
                  this.strategy.execute(resultSet, turbineRolePermission);
                }
            }
