...
{
    /** Serial version */
    private static final long serialVersionUID = 1769223168091L;
        ...
        throws TorqueException
    {
        ...
        addSelectColumns(criteria);
        com.uob.om.TurbinePermissionPeer.addSelectColumns(criteria);
        ...
        criteria.addJoin(TurbineRolePermissionPeer.PERMISSION_ID,
            com.uob.om.TurbinePermissionPeer.PERMISSION_ID);
        ...
        for (List<Object> rawResultRow : rawResult)
        {
            ...
            {
                TurbineRolePermission temp_obj1 = result.get(j);
                com.uob.om.TurbinePermission temp_obj2 = temp_obj1.getTurbinePermission();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTurbineRolePermission(obj1);
