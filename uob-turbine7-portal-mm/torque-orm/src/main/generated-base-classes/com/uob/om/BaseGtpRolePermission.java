...
{
    /** Serial version */
    private static final long serialVersionUID = 1769223161454L;
        ...
        throws TorqueException
    {
        ...
        {
            aGtpPermission = com.uob.om.GtpPermissionPeer.retrieveByPK(SimpleKey.keyFor(this.permissionId));
        }
        ...
        throws TorqueException
    {
        if (aGtpPermission == null && this.permissionId != 0)
        {
            aGtpPermission = com.uob.om.GtpPermissionPeer.retrieveByPK(SimpleKey.keyFor(this.permissionId), connection);
        }
        return aGtpPermission;
    }
    ...
    {
        if (com.uob.om.GtpRolePermissionPeer.ROLE_ID.getSqlExpression().equals(name)
            || com.uob.om.GtpRolePermissionPeer.ROLE_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getRoleId());
        }
        if (com.uob.om.GtpRolePermissionPeer.PERMISSION_ID.getSqlExpression().equals(name)
            || com.uob.om.GtpRolePermissionPeer.PERMISSION_ID.getColumnName().equals(name))
        {
            return Integer.valueOf(getPermissionId());
        }
        return null;
    ...
    /** The Peer class */
    private static final com.uob.om.GtpRolePermissionPeer peer
            = new com.uob.om.GtpRolePermissionPeer();
     ...
     */
    public com.uob.om.GtpRolePermissionPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.uob.om.GtpRolePermissionPeer.getTableMap();
    }
