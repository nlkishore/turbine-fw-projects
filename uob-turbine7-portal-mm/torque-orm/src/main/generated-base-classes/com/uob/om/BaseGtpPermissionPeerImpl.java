...
public abstract class BaseGtpPermissionPeerImpl
    extends org.apache.torque.util.AbstractPeerImpl<GtpPermission>
{
    /** Serial version */
    private static final long serialVersionUID = 1769223167033L;
     ...
     * initialized.
     */
    public BaseGtpPermissionPeerImpl()
    {
        this(new GtpPermissionRecordMapper(),
            GtpPermissionPeer.TABLE,
            GtpPermissionPeer.DATABASE_NAME);
    }
     ...
     */
    public BaseGtpPermissionPeerImpl(
            RecordMapper<GtpPermission> recordMapper, 
            TableMap tableMap,
            String databaseName)
    {
     ...
     */
    public GtpPermission getDbObjectInstance()
    {
        return new GtpPermission();
    }
        ...
        throws TorqueException
    {
...

        {
            JdbcTypedValue pkValue
                = columnValues.remove(GtpPermissionPeer.PERMISSION_ID);
            if (pkValue == null)
            {
                throw new TorqueException(
                        "The value for the primary key column "
                        + "GtpPermissionPeer.PERMISSION_ID"
                        + " must be set");
            }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(GtpPermission obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(GtpPermission obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Collection<GtpPermission> objects)
            throws TorqueException
    {
    ...
    public Criteria buildCriteria(ObjectKey<?> pk)
    {
        ...
        criteria.and(GtpPermissionPeer.PERMISSION_ID, pk);
        return criteria;
     }
    ...
    {
        Criteria criteria = new Criteria();
        criteria.andIn(GtpPermissionPeer.PERMISSION_ID, pks);
        return criteria;
     }
     ...
     */
    public Criteria buildCriteria(GtpPermission obj)
    {
        Criteria criteria = new Criteria(getDatabaseName());
        if (!obj.isNew())
        {
            criteria.and(GtpPermissionPeer.PERMISSION_ID, obj.getEntityId());
        }
        criteria.and(GtpPermissionPeer.PERMISSION_NAME, obj.getEntityName());
        return criteria;
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public Criteria buildSelectCriteria(GtpPermission obj)
    {
        Criteria criteria = new Criteria(getDatabaseName());
        if (!obj.isNew())
        {
     ...
     *         (should not happen).
     */
    public ColumnValues buildColumnValues(GtpPermission gtpPermission)
            throws TorqueException
    {
        ColumnValues columnValues = new ColumnValues();
        if (!gtpPermission.isNew() 
            || gtpPermission.getEntityId() != null)
        {
            columnValues.put(
                    GtpPermissionPeer.PERMISSION_ID,
                    new JdbcTypedValue(
                        gtpPermission.getEntityId(),
                        4));
        }
        columnValues.put(
                GtpPermissionPeer.PERMISSION_NAME,
                new JdbcTypedValue(
                    gtpPermission.getEntityName(),
                    12));
        return columnValues;
    }
     ...
     */
    public GtpPermission retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public GtpPermission retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public GtpPermission retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            GtpPermission result = retrieveByPK(pk, connection);
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public GtpPermission retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        GtpPermission v = doSelectSingleRecord(criteria, con);
        if (v == null)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpPermission> retrieveByTypedPKs(Collection<Integer> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<GtpPermission> result = retrieveByTypedPKs(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpPermission> retrieveByTypedPKs(
            ...
            throws TorqueException
    {
        ...
        {
            return new ArrayList<GtpPermission>();
        }
        ...
        List<GtpPermission> result = doSelect(criteria, dbcon);
        return result;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpPermission> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<GtpPermission> result = retrieveByObjectKeys(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpPermission> retrieveByObjectKeys(
