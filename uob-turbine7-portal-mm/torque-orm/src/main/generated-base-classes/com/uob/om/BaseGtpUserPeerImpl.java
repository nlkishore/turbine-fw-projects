...
public abstract class BaseGtpUserPeerImpl
    extends org.apache.torque.util.AbstractPeerImpl<GtpUser>
{
    /** Serial version */
    private static final long serialVersionUID = 1769223167546L;
     ...
     * initialized.
     */
    public BaseGtpUserPeerImpl()
    {
        this(new GtpUserRecordMapper(),
            GtpUserPeer.TABLE,
            GtpUserPeer.DATABASE_NAME);
    }
     ...
     */
    public BaseGtpUserPeerImpl(
            RecordMapper<GtpUser> recordMapper, 
            TableMap tableMap,
            String databaseName)
    {
     ...
     */
    public GtpUser getDbObjectInstance()
    {
        return new GtpUser();
    }
        ...
        throws TorqueException
    {
...

        {
            JdbcTypedValue pkValue
                = columnValues.remove(GtpUserPeer.USER_ID);
            if (pkValue == null)
            {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(GtpUser obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(GtpUser obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Collection<GtpUser> objects)
            throws TorqueException
    {
    ...
    public Criteria buildCriteria(ObjectKey<?> pk)
    {
        ...
        criteria.and(GtpUserPeer.USER_ID, pk);
        return criteria;
     }
    ...
    {
        Criteria criteria = new Criteria();
        criteria.andIn(GtpUserPeer.USER_ID, pks);
        return criteria;
     }
     ...
     */
    public Criteria buildCriteria(GtpUser obj)
    {
        Criteria criteria = new Criteria(getDatabaseName());
        if (!obj.isNew())
        {
            criteria.and(GtpUserPeer.USER_ID, obj.getEntityId());
        }
        criteria.and(GtpUserPeer.LOGIN_NAME, obj.getEntityName());
        criteria.and(GtpUserPeer.PASSWORD_VALUE, obj.getPassword());
        criteria.and(GtpUserPeer.FIRST_NAME, obj.getFirstName());
        criteria.and(GtpUserPeer.LAST_NAME, obj.getLastName());
        criteria.and(GtpUserPeer.EMAIL, obj.getEmail());
        criteria.and(GtpUserPeer.CONFIRM_VALUE, obj.getConfirmed());
        criteria.and(GtpUserPeer.MODIFIED_DATE, obj.getModifiedDate());
        criteria.and(GtpUserPeer.CREATED, obj.getCreateDate());
        criteria.and(GtpUserPeer.LAST_LOGIN, obj.getLastLogin());
        criteria.and(GtpUserPeer.OBJECTDATA, obj.getObjectdata());
        return criteria;
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public Criteria buildSelectCriteria(GtpUser obj)
    {
        Criteria criteria = new Criteria(getDatabaseName());
        if (!obj.isNew())
        {
     ...
     *         (should not happen).
     */
    public ColumnValues buildColumnValues(GtpUser gtpUser)
            throws TorqueException
    {
        ColumnValues columnValues = new ColumnValues();
        if (!gtpUser.isNew() 
            || gtpUser.getEntityId() != null)
        {
            columnValues.put(
                    GtpUserPeer.USER_ID,
                    new JdbcTypedValue(
        ...
        columnValues.put(
                GtpUserPeer.LOGIN_NAME,
                new JdbcTypedValue(
                    gtpUser.getEntityName(),
                    12));
        columnValues.put(
                GtpUserPeer.PASSWORD_VALUE,
                new JdbcTypedValue(
                    gtpUser.getPassword(),
                    12));
        columnValues.put(
                GtpUserPeer.FIRST_NAME,
                new JdbcTypedValue(
                    gtpUser.getFirstName(),
                    12));
        columnValues.put(
                GtpUserPeer.LAST_NAME,
                new JdbcTypedValue(
                    gtpUser.getLastName(),
                    12));
        columnValues.put(
                ...
                new JdbcTypedValue(
                    ...
                    12));
        columnValues.put(
                GtpUserPeer.CONFIRM_VALUE,
                new JdbcTypedValue(
                    gtpUser.getConfirmed(),
                    12));
        java.util.Date modifiedDate = gtpUser.getModifiedDate();
        if (modifiedDate != null)
        {
            modifiedDate = new java.sql.Timestamp(modifiedDate.getTime());
        }
        columnValues.put(
                GtpUserPeer.MODIFIED_DATE,
                new JdbcTypedValue(modifiedDate, Types.TIMESTAMP));
        java.util.Date createDate = gtpUser.getCreateDate();
        if (createDate != null)
        {
        ...
        java.util.Date lastLogin = gtpUser.getLastLogin();
        if (lastLogin != null)
        {
            lastLogin = new java.sql.Timestamp(lastLogin.getTime());
        }
        columnValues.put(
                GtpUserPeer.LAST_LOGIN,
                new JdbcTypedValue(lastLogin, Types.TIMESTAMP));
        columnValues.put(
                GtpUserPeer.OBJECTDATA,
                new JdbcTypedValue(
                    gtpUser.getObjectdata(),
                    -3));
        return columnValues;
    }
     ...
     */
    public GtpUser retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public GtpUser retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public GtpUser retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            GtpUser result = retrieveByPK(pk, connection);
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public GtpUser retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        GtpUser v = doSelectSingleRecord(criteria, con);
        if (v == null)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpUser> retrieveByTypedPKs(Collection<Integer> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<GtpUser> result = retrieveByTypedPKs(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpUser> retrieveByTypedPKs(
            ...
            throws TorqueException
    {
        ...
        List<GtpUser> result = doSelect(criteria, dbcon);
        return result;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpUser> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<GtpUser> result = retrieveByObjectKeys(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpUser> retrieveByObjectKeys(
