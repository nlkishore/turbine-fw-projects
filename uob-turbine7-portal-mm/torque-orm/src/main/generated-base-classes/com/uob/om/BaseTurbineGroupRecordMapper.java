...
{
    /** Serial version */
    private static final long serialVersionUID = 1769223168965L;

    /** The class log. */
    private static Log log
            = LogFactory.getLog(BaseTurbineGroupRecordMapper.class);
            
    private static final String GROUP_ID_EXPRESSION = BaseTurbineGroupPeer.GROUP_ID.getSqlExpression();
    private static final String GROUP_NAME_EXPRESSION = BaseTurbineGroupPeer.GROUP_NAME.getSqlExpression();

    private boolean useMappingStrategy = true;

    private MappingStrategy<TurbineGroup> strategy;
    
    public void initStrategy()
    {
        this.strategy = new MappingStrategy<TurbineGroup>();
    }
            ...
            else
            {
                ...
                for (Column column : columnsWithoutOffset)
                {
                            ...
                            column.getSqlExpression()))
                    {
                        ...
                        {
                            turbineGroup.setEntityId( getEntityId(resultSet, totalOffset));
                        }
                            ...
                            column.getSqlExpression()))
                    {
                        ...
                        {
                            turbineGroup.setEntityName( getEntityName(resultSet, totalOffset));
                        }
                ...
                if (useMappingStrategy)
                {
                  ...
                  this.strategy.execute(resultSet, turbineGroup);
                }
            }
