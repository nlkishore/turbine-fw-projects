...
public abstract class BaseGtpRolePeer
{
    ...
    private static GtpRolePeerImpl gtpRolePeerImpl;
    ...
    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("kishore")
                .getDatabaseMap();
        if (dbMap.getTable("GTP_ROLE") == null)
        {
            dbMap.addTable("GTP_ROLE");
        }
        DATABASE_NAME = "kishore";
        TABLE_NAME = "GTP_ROLE";

        TABLE = dbMap.getTable("GTP_ROLE");
        TABLE.setJavaName("GtpRole");
        TABLE.setOMClass(com.uob.om.GtpRole.class);
        TABLE.setPeerClass(com.uob.om.GtpRolePeer.class);
        TABLE.setPrimaryKeyMethod(IDMethod.NATIVE);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "GTP_ROLE_SEQ");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "GTP_ROLE");
     ...
     */
    protected static GtpRolePeerImpl createGtpRolePeerImpl()
    {
        GtpRolePeerImpl instance = new GtpRolePeerImpl();
        return instance;
    }
     ...
     */
    public static GtpRolePeerImpl getGtpRolePeerImpl()
    {
        GtpRolePeerImpl peerImplInstance = gtpRolePeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = GtpRolePeer.createGtpRolePeerImpl();
            gtpRolePeerImpl = peerImplInstance;
            Torque.registerPeerInstance(GtpRole.class, peerImplInstance);
        }
     ...
     */
    public static void setGtpRolePeerImpl(GtpRolePeerImpl peerImplInstance)
    {
        gtpRolePeerImpl = peerImplInstance;
    }
    ...
    {
        getGtpRolePeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getGtpRolePeerImpl().correctBooleans(criteria);
    }
    ...
    {
        getGtpRolePeerImpl().correctBooleans(columnValues);
    }
    
    /**
     * Selects GtpRole objects from a database.
     *
     ...
     */
    public static List<GtpRole> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getGtpRolePeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRole> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpRolePeerImpl().doSelect(criteria, connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<GtpRole> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpRolePeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getGtpRolePeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getGtpRolePeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getGtpRolePeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    /**
     * Selects GtpRole objects from the database which have
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRole> doSelect(GtpRole obj)
            throws TorqueException
    {
        return getGtpRolePeerImpl().doSelect(obj);
    }

    /**
     * Selects at most one GtpRole object from a database.
     *
     * @param criteria object used to create the SELECT statement.
     *
     ...
     */
    public static GtpRole doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getGtpRolePeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static GtpRole doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpRolePeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpRolePeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    /**
     * Selects at most one GtpRole object from the database
    ...
    public static GtpRole doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpRolePeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static GtpRole getDbObjectInstance()
    {
        return getGtpRolePeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getGtpRolePeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getGtpRolePeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpRole obj)
            throws TorqueException
    {
        getGtpRolePeerImpl().doInsert(obj);
    }

    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(GtpRole) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpRole obj, Connection con)
            throws TorqueException
    {
        getGtpRolePeerImpl().doInsert(obj, con);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpRolePeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpRolePeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpRolePeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpRolePeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    {
        return getGtpRolePeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getGtpRolePeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getGtpRolePeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
    ...
    /**
     * Updates an GtpRole in the database.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpRole obj) throws TorqueException
    {
        return getGtpRolePeerImpl().doUpdate(obj);
    }

    /**
     * Updates a GtpRole in the database.
     * The primary key is used to identify the object to update.
     * This method is to be used during a transaction,
     * otherwise the doUpdate(GtpRole) method can be used.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use, not null.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpRole obj, Connection con)
        throws TorqueException
    {
        return getGtpRolePeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getGtpRolePeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getGtpRolePeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getGtpRolePeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getGtpRolePeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpRole obj) throws TorqueException
    {
        return getGtpRolePeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpRole obj, Connection con)
        throws TorqueException
    {
        return getGtpRolePeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<GtpRole> objects)
            throws TorqueException
    {
        return getGtpRolePeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
        ...
        throws TorqueException
    {
        return getGtpRolePeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getGtpRolePeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey<?> pk, Connection con)
        throws TorqueException
    {
        return getGtpRolePeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getGtpRolePeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getGtpRolePeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<GtpRole> objects)
    {
        return getGtpRolePeerImpl().buildPkCriteria(objects);
    }
     ...
     */
    public static Criteria buildCriteria(GtpRole obj)
    {
        return getGtpRolePeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(GtpRole obj)
    {
        return getGtpRolePeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(GtpRole gtpRole)
            throws TorqueException
    {
        
        return getGtpRolePeerImpl().buildColumnValues(gtpRole);
    }
     ...
     */
    public static GtpRole retrieveByPK(Integer pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpRolePeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpRole retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpRolePeerImpl().retrieveByPK(pk, con);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpRole retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpRolePeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpRole retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpRolePeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRole> retrieveByTypedPKs(Collection<Integer> pks)
        throws TorqueException
    {
        return getGtpRolePeerImpl().retrieveByTypedPKs(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRole> retrieveByTypedPKs(
                Collection<Integer> pks,
                Connection dbcon)
            throws TorqueException
    {
        return getGtpRolePeerImpl().retrieveByTypedPKs(pks, dbcon);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRole> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getGtpRolePeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpRole> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getGtpRolePeerImpl().retrieveByObjectKeys(pks, con);
    }
     ...
     */
    public static void setAndSaveGtpRolePermissions(
            GtpRole toLinkTo,
            Collection<GtpRolePermission> toSave) 
        throws TorqueException
    {
        getGtpRolePeerImpl().setAndSaveGtpRolePermissions(toLinkTo, toSave);
    }
     ...
     * @throws NullPointerException if toSave is null or contains null elements.
     */
    public static void setAndSaveGtpGroupRoles(
            GtpRole toLinkTo,
            Collection<GtpGroupRole> toSave) 
        throws TorqueException
    {
        getGtpRolePeerImpl().setAndSaveGtpGroupRoles(toLinkTo, toSave);
    }
     ...
     * @throws NullPointerException if toSave is null or contains null elements.
     */
    public static void setAndSaveGtpUserGroupRoles(
            GtpRole toLinkTo,
            Collection<GtpUserGroupRole> toSave) 
        throws TorqueException
    {
        getGtpRolePeerImpl().setAndSaveGtpUserGroupRoles(toLinkTo, toSave);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getGtpRolePeerImpl().getTableMap();
    }
