...
public abstract class BaseGtpGroupRolePeer
{
    ...
    private static GtpGroupRolePeerImpl gtpGroupRolePeerImpl;
    ...
    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("kishore")
                .getDatabaseMap();
        if (dbMap.getTable("GTP_GROUP_ROLE") == null)
        {
            dbMap.addTable("GTP_GROUP_ROLE");
        }
        DATABASE_NAME = "kishore";
        TABLE_NAME = "GTP_GROUP_ROLE";

        TABLE = dbMap.getTable("GTP_GROUP_ROLE");
        TABLE.setJavaName("GtpGroupRole");
        TABLE.setOMClass(com.uob.om.GtpGroupRole.class);
        TABLE.setPeerClass(com.uob.om.GtpGroupRolePeer.class);
        TABLE.setPrimaryKeyMethod(IDMethod.NO_ID_METHOD);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "$sequenceName");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "GTP_GROUP_ROLE");
     ...
     */
    protected static GtpGroupRolePeerImpl createGtpGroupRolePeerImpl()
    {
        GtpGroupRolePeerImpl instance = new GtpGroupRolePeerImpl();
        return instance;
    }
     ...
     */
    public static GtpGroupRolePeerImpl getGtpGroupRolePeerImpl()
    {
        GtpGroupRolePeerImpl peerImplInstance = gtpGroupRolePeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = GtpGroupRolePeer.createGtpGroupRolePeerImpl();
            gtpGroupRolePeerImpl = peerImplInstance;
            Torque.registerPeerInstance(GtpGroupRole.class, peerImplInstance);
        }
     ...
     */
    public static void setGtpGroupRolePeerImpl(GtpGroupRolePeerImpl peerImplInstance)
    {
        gtpGroupRolePeerImpl = peerImplInstance;
    }
    ...
    {
        getGtpGroupRolePeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getGtpGroupRolePeerImpl().correctBooleans(criteria);
    }
    ...
    {
        getGtpGroupRolePeerImpl().correctBooleans(columnValues);
    }
    
    /**
     * Selects GtpGroupRole objects from a database.
     *
     ...
     */
    public static List<GtpGroupRole> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroupRole> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelect(criteria, connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Stream<GtpGroupRole> doSelectAsStream(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelectAsStream(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
    ...
    public static <T> Stream<T> doSelectAsStream(
        ...
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelectAsStream(
                criteria,
                mapper,
                connection);
    }
    ...
    /**
     * Selects GtpGroupRole objects from the database which have
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroupRole> doSelect(GtpGroupRole obj)
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelect(obj);
    }

    /**
     * Selects at most one GtpGroupRole object from a database.
     *
     * @param criteria object used to create the SELECT statement.
     *
     ...
     */
    public static GtpGroupRole doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static GtpGroupRole doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    /**
     * Selects at most one GtpGroupRole object from the database
    ...
    public static GtpGroupRole doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static GtpGroupRole getDbObjectInstance()
    {
        return getGtpGroupRolePeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey<?> doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpGroupRole obj)
            throws TorqueException
    {
        getGtpGroupRolePeerImpl().doInsert(obj);
    }

    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(GtpGroupRole) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(GtpGroupRole obj, Connection con)
            throws TorqueException
    {
        getGtpGroupRolePeerImpl().doInsert(obj, con);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doInsert(toInsertInto, criteria);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doInsert(toInsertInto, criteria, dbName);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doInsert(toInsertInto, criteria, connection);
    }
    ...
    public static int doInsert(
            ...
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doInsert(
                 toInsertInto,
                 criteria,
                 dbName,
                 connection);
    ...
    {
        return getGtpGroupRolePeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
    ...
    /**
     * Updates an GtpGroupRole in the database.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpGroupRole obj) throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doUpdate(obj);
    }

    /**
     * Updates a GtpGroupRole in the database.
     * The primary key is used to identify the object to update.
     * This method is to be used during a transaction,
     * otherwise the doUpdate(GtpGroupRole) method can be used.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use, not null.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(GtpGroupRole obj, Connection con)
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getGtpGroupRolePeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getGtpGroupRolePeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpGroupRole obj) throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(GtpGroupRole obj, Connection con)
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<GtpGroupRole> objects)
            throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
        ...
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getGtpGroupRolePeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey<?> pk, Connection con)
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getGtpGroupRolePeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getGtpGroupRolePeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<GtpGroupRole> objects)
    {
        return getGtpGroupRolePeerImpl().buildPkCriteria(objects);
    }
     ...
     */
    public static Criteria buildCriteria(GtpGroupRole obj)
    {
        return getGtpGroupRolePeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(GtpGroupRole obj)
    {
        return getGtpGroupRolePeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(GtpGroupRole gtpGroupRole)
            throws TorqueException
    {
        
        return getGtpGroupRolePeerImpl().buildColumnValues(gtpGroupRole);
    }
     ...
     * @param roleId int
     */
    public static GtpGroupRole retrieveByPK(
            int groupId,
            int roleId)
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().retrieveByPK(
                groupId,
                roleId);
    }
     ...
     */
    public static GtpGroupRole retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpGroupRolePeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static GtpGroupRole retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getGtpGroupRolePeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroupRole> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().retrieveByObjectKeys(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroupRole> retrieveByObjectKeys(Collection<ObjectKey<?>> pks, Connection con)
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().retrieveByObjectKeys(pks, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroupRole> doSelectJoinGtpGroup(Criteria criteria)
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelectJoinGtpGroup(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroupRole> doSelectJoinGtpGroup(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelectJoinGtpGroup(criteria, conn);
    }
    /**
     * Selects a collection of dbObjectClassName objects pre-filled with their
     * GtpRole objects.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroupRole> doSelectJoinGtpRole(Criteria criteria)
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelectJoinGtpRole(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<GtpGroupRole> doSelectJoinGtpRole(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().doSelectJoinGtpRole(criteria, conn);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getGtpGroupRolePeerImpl().getTableMap();
    }
