...
{
    /** Serial version */
    private static final long serialVersionUID = 1769223163264L;
    ...
    public List<TurbineRolePermission> getTurbineRolePermissions(Criteria criteria) throws TorqueException
    {
        if (collTurbineRolePermissions == null)
        {
            ...
            {
                criteria.and(com.uob.om.TurbineRolePermissionPeer.ROLE_ID, getEntityId());
    ...
    public List<TurbineUserGroupRole> getTurbineUserGroupRoles(Criteria criteria) throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(com.uob.om.TurbineUserGroupRolePeer.ROLE_ID, getEntityId());
        ...
        throws TorqueException
    {
        if (collTurbineRolePermissions == null)
        {
            ...
            {
                criteria.and(com.uob.om.TurbineRolePermissionPeer.ROLE_ID, getEntityId());
                collTurbineRolePermissions = com.uob.om.TurbineRolePermissionPeer.doSelectJoinTurbinePermission(criteria, connection);
                for (TurbineRolePermission turbineRolePermission : collTurbineRolePermissions)
                {
                    turbineRolePermission.setTurbineRole((TurbineRole) this);
                }
    ...
    {
        if (com.uob.om.TurbineRolePeer.ROLE_ID.getSqlExpression().equals(name)
            || com.uob.om.TurbineRolePeer.ROLE_ID.getColumnName().equals(name))
        {
            return getEntityId();
        }
        if (com.uob.om.TurbineRolePeer.ROLE_NAME.getSqlExpression().equals(name)
            || com.uob.om.TurbineRolePeer.ROLE_NAME.getColumnName().equals(name))
        {
            return getEntityName();
        }
        return null;
    ...
    /** The Peer class */
    private static final com.uob.om.TurbineRolePeer peer
            = new com.uob.om.TurbineRolePeer();
     ...
     */
    public com.uob.om.TurbineRolePeer getPeer()
    {
        return peer;
    }
    ...
    {
        return com.uob.om.TurbineRolePeer.getTableMap();
    }
