...
public abstract class BaseTurbineRolePeerImpl
    extends org.apache.torque.util.AbstractPeerImpl<TurbineRole>
{
    /** Serial version */
    private static final long serialVersionUID = 1769223168030L;
        ...
        throws TorqueException
    {
...

        {
            JdbcTypedValue pkValue
                = columnValues.remove(TurbineRolePeer.ROLE_ID);
            if (pkValue == null)
            {
        ...
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        TurbineRole v = doSelectSingleRecord(criteria, con);
        if (v == null)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<TurbineRole> retrieveByTypedPKs(Collection<Integer> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<TurbineRole> result = retrieveByTypedPKs(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<TurbineRole> retrieveByTypedPKs(
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<TurbineRole> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<TurbineRole> result = retrieveByObjectKeys(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<TurbineRole> retrieveByObjectKeys(
