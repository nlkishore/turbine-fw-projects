...
public abstract class BaseGtpGroupPeerImpl
    extends org.apache.torque.util.AbstractPeerImpl<GtpGroup>
{
    /** Serial version */
    private static final long serialVersionUID = 1769223167354L;
     ...
     * initialized.
     */
    public BaseGtpGroupPeerImpl()
    {
        this(new GtpGroupRecordMapper(),
            GtpGroupPeer.TABLE,
            GtpGroupPeer.DATABASE_NAME);
    }
     ...
     */
    public BaseGtpGroupPeerImpl(
            RecordMapper<GtpGroup> recordMapper, 
            TableMap tableMap,
            String databaseName)
    {
     ...
     */
    public GtpGroup getDbObjectInstance()
    {
        return new GtpGroup();
    }
        ...
        throws TorqueException
    {
...

        {
            JdbcTypedValue pkValue
                = columnValues.remove(GtpGroupPeer.GROUP_ID);
            if (pkValue == null)
            {
                throw new TorqueException(
                        "The value for the primary key column "
                        + "GtpGroupPeer.GROUP_ID"
                        + " must be set");
            }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(GtpGroup obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(GtpGroup obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Collection<GtpGroup> objects)
            throws TorqueException
    {
    ...
    public Criteria buildCriteria(ObjectKey<?> pk)
    {
        ...
        criteria.and(GtpGroupPeer.GROUP_ID, pk);
        return criteria;
     }
    ...
    {
        Criteria criteria = new Criteria();
        criteria.andIn(GtpGroupPeer.GROUP_ID, pks);
        return criteria;
     }
     ...
     */
    public Criteria buildCriteria(GtpGroup obj)
    {
        Criteria criteria = new Criteria(getDatabaseName());
        if (!obj.isNew())
        {
            criteria.and(GtpGroupPeer.GROUP_ID, obj.getEntityId());
        }
        criteria.and(GtpGroupPeer.GROUP_NAME, obj.getEntityName());
        return criteria;
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public Criteria buildSelectCriteria(GtpGroup obj)
    {
        Criteria criteria = new Criteria(getDatabaseName());
        if (!obj.isNew())
        {
     ...
     *         (should not happen).
     */
    public ColumnValues buildColumnValues(GtpGroup gtpGroup)
            throws TorqueException
    {
        ColumnValues columnValues = new ColumnValues();
        if (!gtpGroup.isNew() 
            || gtpGroup.getEntityId() != null)
        {
            columnValues.put(
                    GtpGroupPeer.GROUP_ID,
                    new JdbcTypedValue(
                        gtpGroup.getEntityId(),
                        4));
        }
        columnValues.put(
                GtpGroupPeer.GROUP_NAME,
                new JdbcTypedValue(
                    gtpGroup.getEntityName(),
                    12));
        return columnValues;
    }
     ...
     */
    public GtpGroup retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public GtpGroup retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public GtpGroup retrieveByPK(ObjectKey<?> pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            GtpGroup result = retrieveByPK(pk, connection);
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public GtpGroup retrieveByPK(ObjectKey<?> pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        GtpGroup v = doSelectSingleRecord(criteria, con);
        if (v == null)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpGroup> retrieveByTypedPKs(Collection<Integer> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<GtpGroup> result = retrieveByTypedPKs(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpGroup> retrieveByTypedPKs(
            ...
            throws TorqueException
    {
        ...
        List<GtpGroup> result = doSelect(criteria, dbcon);
        return result;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpGroup> retrieveByObjectKeys(Collection<ObjectKey<?>> pks)
        throws TorqueException
    {
        try (TorqueConnection connection = Transaction.begin(getDatabaseName()))
        {
            List<GtpGroup> result = retrieveByObjectKeys(pks, connection);
            Transaction.commit(connection);
            return result;
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<GtpGroup> retrieveByObjectKeys(
